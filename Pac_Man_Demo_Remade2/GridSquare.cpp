...
GridSquare labyrinth;
Tile tile;




GridSquare::GridSquare() :tileVals{
...
int GridSquare::getTileInt(int x, int y)
{
...
bool GridSquare::moveChecker(int x, int y)
{
	
	int z = labyrinth.getTileInt(x, y);
